"""
CNN with 3 conv layers with dropout and a fully connected classification layer
"""
...
class CNN_dropout(nn.Module):
    ...
    conv3 : torch.nn.Sequential
        Convolutional layers of the network with dropout
    fc : torch.nn.Linear
    ...
    def __init__(self, output_channels=10, input_channels=3, **kwargs):
        """
        Creates an CNN_dropout model from the scratch.
